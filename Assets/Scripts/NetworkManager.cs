...
public class NetworkManager : MonoBehaviourPunCallbacks {
    ...
    void Start() {
        ...
        Debug.Log("Start() function ... Connecting to lobby...");
    }
    ...
    public override void OnConnectedToMaster() {
        Debug.Log("OnConnectedToMaster() function is called ...");
    ...
    public override void OnDisconnected(DisconnectCause cause) {
        Debug.Log("OnDisconnected() function is called ...");
    ...
    public override void OnJoinedLobby() {
        Debug.Log("OnJoinedLobby() function is called ...");
    ...
    public override void OnRoomListUpdate(List<RoomInfo> rooms) {
        Debug.Log("OnRoomListUpdate() function is called ...");
        roomList.text = "";
    ...
    public void JoinRoom() {
        Debug.Log("JoinRoom() function is called ...");

        serverWindow.SetActive(false);
        connectionText.text = "Joining room...";
        Debug.Log("JoinRoom() function ... Joining room...");
    ...
    public override void OnJoinedRoom() {
        Debug.Log("OnJoinedRoom() function is called ...");
        connectionText.text = "";
    ...
    void Respawn(float spawnTime) {
        Debug.Log("Respawn() function is called ...");
    ...
    IEnumerator RespawnCoroutine(float spawnTime) {
        ...
        if (spawnTime == 0) {
            ...
            Debug.Log("Player " + PhotonNetwork.LocalPlayer.NickName + " Joined Game.");
        } else {
            AddMessage("Player " + PhotonNetwork.LocalPlayer.NickName + " Respawned.");
            Debug.Log("Player " + PhotonNetwork.LocalPlayer.NickName + " Respawned.");
        }
    }
    ...
    void AddMessage(string message) {
        ...
        Debug.Log("AddMessage() function is called ..." + message);
    }
    ...
    public override void OnPlayerLeftRoom(Player other) {
        Debug.Log("OnPlayerLeftRoom() function is called ...");
